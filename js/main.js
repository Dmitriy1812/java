...
/* harmony import */ var _components_just_validate_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/just-validate.js */ "./src/js/components/just-validate.js");
/* harmony import */ var _components_to_top_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/to-top.js */ "./src/js/components/to-top.js");
...
const rellax = new (rellax__WEBPACK_IMPORTED_MODULE_2___default())('.rellax');
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.form-1', rules1, afterForm);
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.form-2', rules2, afterForm);
...
if (document.querySelector('.hero')) {
  heroHeight = document.querySelector('.hero').offsetHeight / 2;
...
window.addEventListener('scroll', () => {
  ...
  (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_0__.throttle)(isVisibleToTop(y));
  // isVisibleToTop(y);
});
...
(function () {
  ...
  //     if (!e.target.closest('[data-menu]') && e.target !== burger) {
...
const validateForms = (selector, rules, afterSend) => {
  ...
  const validation = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"](selector, {
    errorLabelStyle: {
      color: getComputedStyle(document.documentElement).getPropertyValue('--monza-color')
    },
